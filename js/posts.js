...
function viewUserPosts() {
  if (window.localStorage["jwt-token"]) {
    fetch(`https://dynamicoakfx.herokuapp.com/view-users-posts/${window.localStorage["user-id"]}/`, {
      method: "GET",
      headers: {
...
function deletePost(post_id) {
  fetch(`https://dynamicoakfx.herokuapp.com/delete-post/${post_id}/`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `jwt ${window.localStorage["jwt-token"]}`,
...
function editImage(post_id) {
    fetch(`https://dynamicoakfx.herokuapp.com/edit-post/${post_id}/`, {
        method: "PUT", 
        body: JSON.stringify ({
...
// function editId() {
//   fetch(`https://dynamicoakfx.herokuapp.com/edit-post/${window.localStorage["postID"]}/`, {
//     method: "PUT",
//     body: JSON.stringify ({
...
function createPost() {
  ...
  if (window.localStorage["jwt-token"]) {
    fetch(`https://dynamicoakfx.herokuapp.com/create-post/`, {
      method: "POST",
      body: JSON.stringify({
