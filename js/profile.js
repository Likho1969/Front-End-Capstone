...
function viewProfile() {
  if (window.localStorage["jwt-token"]) {
    fetch(`https://dynamicoakfx.herokuapp.com/view-profile/${window.localStorage["username"]}/`, {
      method: "GET",
      headers: {
...
function editPicture() {
  ...
  fetch(`https://dynamicoakfx.herokuapp.com/edit-profile/${window.localStorage["username"]}/`, {
    method: "PUT",
    body: JSON.stringify ({
...
function deleteProfile() {
    fetch(
      `https://dynamicoakfx.herokuapp.com/delete-profile/${window.localStorage["username"]}/`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
